...
export default function AboutPage() {
    return (
        <>
            <div className="px-5 md:px-20 pt-14 pb-20">
                ...
                <div className="flex flex-col lg:flex-row justify-center mt-10 gap-8">
                    <div className="w-full lg:w-1/2 h-64 sm:h-96 md:h-[500px]">
                        <img src={coverPhoto} alt="foto portada" className="w-full h-full object-cover object-center" />
                    </div>

                    <div className="border lg:border-0 border-almond-silk-600/30 mt-10 lg:mt-0 px-6 py-3 lg:px-10 md:py-5 flex flex-col gap-4 w-full lg:w-1/2 bg-neutral-50 ">
