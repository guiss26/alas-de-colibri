        ...
        <>
            <div className="px-7 md:px-20 pt-12 pb-20">
                ...
                <div className="mt-15 lg:flex lg:gap-5">
                    <form className="lg:w-2/3 bg-blanco border border-almond-silk-300/30 p-7 rounded mb-10 lg:mb-0 shadow-md">
                        ...
                        <div className="flex md:flex-row gap-5">
                            <div className="flex flex-col gap-3 mb-5 w-full">
                                ...
                                <input type="text" id="name-builder" name="name-builder" className="bg-almond-silk-100/40 p-3 rounded border border-almond-silk-200/10 text-sm sm:text-base font-light" />
                            </div>

                            <div className="flex flex-col gap-3 mb-5 w-full">
                                <label htmlFor="email-builder" className="text-sm sm:text-base font-light">Email *</label>
                                <input type="text" id="email-builder" name="email-builder" className="bg-almond-silk-100/40 p-3 rounded border border-almond-silk-200/10 text-sm sm:text-base font-light" />
                            </div>
                        </div>

                        <div className="flex flex-col gap-3 mb-5">
                            <label htmlFor="whatsapp-builder" className="text-sm sm:text-base font-light">WhatsApp</label>
                            <input type="tel" id="whatsapp-builder" name="whatsapp-builder" className="bg-almond-silk-100/40 p-3 rounded border border-almond-silk-200/10 text-sm sm:text-base font-light" />
                        </div>

                        <div className="flex flex-col gap-3 mb-5">
                            <label htmlFor="description-builder" className="text-sm sm:text-base font-light">Descripción de tu joya ideal*</label>
                            <textarea name="description-builder" id="description-builder" placeholder="Cuéntanos todos los detalles: tipo de joya, estilo, tamaño, colores preferidos, ocasión especial..." className="bg-almond-silk-100/40 p-3 rounded border border-almond-silk-200/10 text-sm sm:text-base font-light"></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            {/* Card Slider */}
                            <div className="flex gap-4 mb-5 overflow-x-auto scrollbar-hide pb-2">
                                {stones.map((stone) => (
                                    <div key={stone.id} className="border border-almond-silk-300/30 p-3 flex-shrink-0 w-[150px]">
                                        <img src={stone.image} alt={stone.name} className="mb-2" width={150} height={100} />
                                        <p className="text-center text-sm text-neutral-600">{stone.name} </p>

                                    </div>
                                ))}
                            </div>

                            <button className="bg-fondo-boton/90 hover:bg-hover-boton w-full py-3 rounded-xl font-light">Enviar solicitud</button>
                        </div>
                    </form>

                    <div className="lg:w-1/3 flex flex-col gap-5">
                        <div className="bg-turquesa-suave-200 p-7 shadow-md">
                        ...
                        <div className="bg-blanco border border-almond-silk-300/30 p-7 shadow-md">
